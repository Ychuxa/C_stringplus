...
START_TEST(sscanf1) {
  ...
  ck_assert(fabs(b1 - 45.67f) <= S21_TOL); // Compare floats with S21_TOL
...
int main(void) {
  ...
  Suite *s22 = suite_create("s21_sscanf");
  TCase *tc22_1 = tcase_create("s21_sscanf");
  Suite *s23 = suite_create("strchr");
  TCase *tc23_1 = tcase_create("strchr");
  Suite *s24 = suite_create("strcspn");
  TCase *tc24_1 = tcase_create("strcspn");
  Suite *s25 = suite_create("strerror");
  TCase *tc25_1 = tcase_create("strerror");
  Suite *s26 = suite_create("strlen");
  TCase *tc26_1 = tcase_create("strlen");
  Suite *s27 = suite_create("strncat");
  TCase *tc27_1 = tcase_create("strncat");
  Suite *s28 = suite_create("strncmp");
  TCase *tc28_1 = tcase_create("strncmp");
  Suite *s29 = suite_create("strncpy");
  TCase *tc29_1 = tcase_create("strncpy");
  Suite *s30 = suite_create("strpbrk");
  TCase *tc30_1 = tcase_create("strpbrk");
  Suite *s31 = suite_create("strrchr");
  TCase *tc31_1 = tcase_create("strrchr");
  Suite *s32 = suite_create("strstr");
  TCase *tc32_1 = tcase_create("strstr");
  Suite *s33 = suite_create("strtok");
  TCase *tc33_1 = tcase_create("strtok");
  Suite *s34 = suite_create("to_lower");
  TCase *tc34_1 = tcase_create("to_lower");
  Suite *s35 = suite_create("to_upper");
  TCase *tc35_1 = tcase_create("to_upper");
  Suite *s36 = suite_create("trim");
  TCase *tc36_1 = tcase_create("trim");
  Suite *s37 = suite_create("uitoa");
  TCase *tc37_1 = tcase_create("uitoa");
  ...
  tcase_add_test(tc22_1, sscanf1);
  tcase_add_test(tc22_1, sscanf2);
  tcase_add_test(tc22_1, sscanf3);
  tcase_add_test(tc22_1, sscanf4);
  tcase_add_test(tc22_1, sscanf5);
  tcase_add_test(tc22_1, sscanf6);
  suite_add_tcase(s23, tc23_1);
  tcase_add_test(tc23_1, strchr1);
  tcase_add_test(tc23_1, strchr2);
  tcase_add_test(tc23_1, strchr3);
  tcase_add_test(tc23_1, strchr4);
  tcase_add_test(tc23_1, strchr5);
  tcase_add_test(tc23_1, strchr6);
  tcase_add_test(tc23_1, strchr7);
  tcase_add_test(tc23_1, strchr8);
  suite_add_tcase(s24, tc24_1);
  tcase_add_test(tc24_1, strcspn1);
  tcase_add_test(tc24_1, strcspn2);
  tcase_add_test(tc24_1, strcspn3);
  tcase_add_test(tc24_1, strcspn4);
  tcase_add_test(tc24_1, strcspn5);
  tcase_add_test(tc24_1, strcspn6);
  tcase_add_test(tc24_1, strcspn7);
  tcase_add_test(tc24_1, strcspn8);
  tcase_add_test(tc24_1, strcspn9);
  tcase_add_test(tc24_1, strcspn10);
  tcase_add_test(tc24_1, strcspn11);
  tcase_add_test(tc24_1, strcspn12);
  tcase_add_test(tc24_1, strcspn13);
  suite_add_tcase(s25, tc25_1);
  tcase_add_test(tc25_1, strerror1);
  tcase_add_test(tc25_1, strerror2);
  suite_add_tcase(s26, tc26_1);
  tcase_add_test(tc26_1, strlen1);
  tcase_add_test(tc26_1, strlen2);
  tcase_add_test(tc26_1, strlen3);
  tcase_add_test(tc26_1, strlen4);
  suite_add_tcase(s27, tc27_1);
  tcase_add_test(tc27_1, strncat1);
  tcase_add_test(tc27_1, strncat2);
  tcase_add_test(tc27_1, strncat3);
  tcase_add_test(tc27_1, strncat4);
  tcase_add_test(tc27_1, strncat5);
  tcase_add_test(tc27_1, strncat6);
  tcase_add_test(tc27_1, strncat7);
  tcase_add_test(tc27_1, strncat8);
  tcase_add_test(tc27_1, strncat9);
  tcase_add_test(tc27_1, strncat10);
  tcase_add_test(tc27_1, strncat11);
  suite_add_tcase(s28, tc28_1);
  tcase_add_test(tc28_1, strncmp1);
  tcase_add_test(tc28_1, strncmp2);
  tcase_add_test(tc28_1, strncmp3);
  tcase_add_test(tc28_1, strncmp4);
  tcase_add_test(tc28_1, strncmp5);
  tcase_add_test(tc28_1, strncmp6);
  tcase_add_test(tc28_1, strncmp7);
  tcase_add_test(tc28_1, strncmp8);
  tcase_add_test(tc28_1, strncmp9);
  suite_add_tcase(s29, tc29_1);
  tcase_add_test(tc29_1, strncpy1);
  tcase_add_test(tc29_1, strncpy2);
  tcase_add_test(tc29_1, strncpy3);
  tcase_add_test(tc29_1, strncpy4);
  tcase_add_test(tc29_1, strncpy5);
  tcase_add_test(tc29_1, strncpy6);
  tcase_add_test(tc29_1, strncpy7);
  tcase_add_test(tc29_1, strncpy8);
  tcase_add_test(tc29_1, strncpy9);
  suite_add_tcase(s30, tc30_1);
  tcase_add_test(tc30_1, strpbrk1);
  tcase_add_test(tc30_1, strpbrk2);
  tcase_add_test(tc30_1, strpbrk3);
  tcase_add_test(tc30_1, strpbrk4);
  tcase_add_test(tc30_1, strpbrk5);
  tcase_add_test(tc30_1, strpbrk6);
  tcase_add_test(tc30_1, strpbrk7);
  tcase_add_test(tc30_1, strpbrk8);
  tcase_add_test(tc30_1, strpbrk9);
  tcase_add_test(tc30_1, strpbrk10);
  suite_add_tcase(s31, tc31_1);
  tcase_add_test(tc31_1, strrchr1);
  tcase_add_test(tc31_1, strrchr2);
  tcase_add_test(tc31_1, strrchr3);
  tcase_add_test(tc31_1, strrchr4);
  tcase_add_test(tc31_1, strrchr5);
  tcase_add_test(tc31_1, strrchr6);
  tcase_add_test(tc31_1, strrchr7);
  tcase_add_test(tc31_1, strrchr8);
  tcase_add_test(tc31_1, strrchr9);
  tcase_add_test(tc31_1, strrchr10);
  tcase_add_test(tc31_1, strrchr11);
  tcase_add_test(tc31_1, strrchr12);
  tcase_add_test(tc31_1, strrchr13);
  suite_add_tcase(s32, tc32_1);
  tcase_add_test(tc32_1, strstr1);
  tcase_add_test(tc32_1, strstr2);
  tcase_add_test(tc32_1, strstr3);
  tcase_add_test(tc32_1, strstr4);
  tcase_add_test(tc32_1, strstr5);
  tcase_add_test(tc32_1, strstr6);
  tcase_add_test(tc32_1, strstr7);
  tcase_add_test(tc32_1, strstr8);
  tcase_add_test(tc32_1, strstr9);
  suite_add_tcase(s33, tc33_1);
  tcase_add_test(tc33_1, strtok1);
  tcase_add_test(tc33_1, strtok2);
  tcase_add_test(tc33_1, strtok3);
  tcase_add_test(tc33_1, strtok4);
  tcase_add_test(tc33_1, strtok5);
  tcase_add_test(tc33_1, strtok6);
  tcase_add_test(tc33_1, strtok7);
  tcase_add_test(tc33_1, strtok8);
  tcase_add_test(tc33_1, strtok9);
  tcase_add_test(tc33_1, strtok10);
  tcase_add_test(tc33_1, strtok11);
  tcase_add_test(tc33_1, strtok12);
  tcase_add_test(tc33_1, strtok13);
  tcase_add_test(tc33_1, strtok14);
  tcase_add_test(tc33_1, strtok15);
  suite_add_tcase(s34, tc34_1);
  tcase_add_test(tc34_1, to_lower1);
  tcase_add_test(tc34_1, to_lower2);
  tcase_add_test(tc34_1, to_lower3);
  tcase_add_test(tc34_1, to_lower4);
  tcase_add_test(tc34_1, to_lower5);
  tcase_add_test(tc34_1, to_lower6);
  suite_add_tcase(s35, tc35_1);
  tcase_add_test(tc35_1, to_upper1);
  tcase_add_test(tc35_1, to_upper2);
  tcase_add_test(tc35_1, to_upper3);
  tcase_add_test(tc35_1, to_upper4);
  tcase_add_test(tc35_1, to_upper5);
  tcase_add_test(tc35_1, to_upper6);
  suite_add_tcase(s36, tc36_1);
  tcase_add_test(tc36_1, trim1);
  tcase_add_test(tc36_1, trim2);
  tcase_add_test(tc36_1, trim3);
  tcase_add_test(tc36_1, trim4);
  tcase_add_test(tc36_1, trim5);
  tcase_add_test(tc36_1, trim6);
  tcase_add_test(tc36_1, trim7);
  suite_add_tcase(s37, tc37_1);
  tcase_add_test(tc37_1, uitoa1);
  tcase_add_test(tc37_1, uitoa2);
  tcase_add_test(tc37_1, uitoa3);
  tcase_add_test(tc37_1, uitoa4);
  tcase_add_test(tc37_1, uitoa5);
